import { calculateStrategy, evaluateScenario, scenarioCurve, scenarioFacts, scenarioHeatmap, scenarioTable, scenarioSpotAttribution, isChartRange, type ChartRange, type StrategyState } from "./options";

export type WorkspaceView = "table" | "heatmap" | { kind: "curve"; min: number; max: number; metric: keyof ReturnType<typeof evaluateScenario>; comparison?: StrategyState };
