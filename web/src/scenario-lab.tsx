...
import { LabRiskPanels } from './lab-risk-panels'
...
function ScenarioLab() {
  ...
  return <main className="lab">
    ...
    <div className="lab-workspace"><div className="lab-main">
      ...
      <LabRiskPanels position={position} scenario={activeState} snapshot={snapshot ?? undefined}/>
