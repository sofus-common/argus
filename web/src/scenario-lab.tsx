...
function ScenarioLab() {
  ...
  return <main className="lab">
    ...
    <footer className="lab-footer"><span role="status">{notice || (snapshot ? 'Dated quote snapshot · no broker order connection' : 'Synthetic example · no market or broker connection')}</span><span>Local draft only · six interactive strategy families · no assignment simulation</span></footer>
